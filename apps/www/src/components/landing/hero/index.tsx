...
export const HeroSection = () => {
  return (
    <div className="relative flex  max-w-8xl card bg-gradient-circle w-full justify-between px-4 sm:px-8 sm:py-10 pb-8 sm:border from-gray-50 to-gray-200 dark:border-stone-900 dark:from-brand-900/20 dark:to-stone-950/80 sm:min-h-fit md:px-16 md:py-12  md:pt-16 rounded-3xl">
